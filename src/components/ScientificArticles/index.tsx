          ...
          {userData.length > 0 && (
            <>
              <div className="slider-content">
                <p className={`article-recent ${inter.className}`}>ARTÍCULOS MAS RECIENTES</p>
                <p className={`article-date ${lato.className}`}>{getCurrentDate()}</p>
                <p className={`article-title ${montserrat.className}`}>{userData[currentSlide].name}</p>
                <p className={`article-content ${lato.className }`}>{userData[currentSlide].body}</p>
                <h3 className={`article-author ${roboto.className}`}>{userData[currentSlide].email}</h3>
                  <BtnComponent/>
